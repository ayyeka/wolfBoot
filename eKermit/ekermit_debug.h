...
#ifndef EKERMIT_DEBUG				/* and if EKERMIT_DEBUG not already defined */
#ifndef MINSIZE				/* MINSIZE inhibits debugging */
#ifndef EKERMIT_DEBUG
#define EKERMIT_DEBUG
#endif /* EKERMIT_DEBUG */
#endif /* MINSIZE */
#endif /* EKERMIT_DEBUG */
#endif /* NODEBUG */

#ifdef EKERMIT_DEBUG				/* Debugging included... */
...
/*
  dodebug() is accessed throug a macro that:
   ...
   . Makes it disappear entirely if EKERMIT_DEBUG not defined.
*/
#ifdef KERMIT_C
